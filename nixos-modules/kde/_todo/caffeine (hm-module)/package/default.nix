...
let
  icon = {
    light = {
      full = "${pkgs.fluent-icon-theme}/share/icons/Fluent/symbolic/status/caffeine-cup-full-symbolic.svg";
      empty = "${pkgs.fluent-icon-theme}/share/icons/Fluent/symbolic/status/caffeine-cup-empty-symbolic.svg";
    };
    dark = {
      full = "${pkgs.fluent-icon-theme}/share/icons/Fluent-dark/symbolic/status/caffeine-cup-full-symbolic.svg";
      empty = "${pkgs.fluent-icon-theme}/share/icons/Fluent-dark/symbolic/status/caffeine-cup-empty-symbolic.svg";
    };
  };

  iconPkg = pkgs.runCommandLocal "caffeine-ng-icon" { } ''
